...
class Model:
    ...
    def completion(self, inputs, is_training):
        ...
        with tf.variable_scope('encoder_0', reuse=tf.AUTO_REUSE):
            ...
            l5_xyz, l5_points, l5_indices = pointnet_sa_module(l4_xyz, l4_points, npoint=num_point / 8,
            ...
            gl_xyz, gl_points, gl_indices = pointnet_sa_module(l4_xyz, l4_points, npoint=1,
                                                               radius=bradius * 0.3, bn=use_bn, ibn=use_ibn,
                                                               nsample=32, mlp=[512, 512, 1024], mlp2=None,
                                                               group_all=True,
                                                               is_training=is_training, bn_decay=bn_decay,
            ...
            print('up_l5_points', up_l5_points, l5_points)
            ...
            print('up_l4_points', up_l4_points, l4_points)
            ...
            print('up_l3_points', up_l3_points, l3_points)
        ...
        with tf.variable_scope('up_layer', reuse=tf.AUTO_REUSE):
            ...
            for i in range(up_ratio):
                if i>3:
                    ...
                    concat_feat = tf.concat([up_gl_points, up_l5_points, up_l4_points, up_l3_points, xyz_transformed],
                                            axis=-1)
                    print('concat_feat1', concat_feat)
                else:
                    concat_feat = tf.concat([up_gl_points, up_l3_points, up_l2_points, l1_points, l0_xyz],
                                            axis=-1)
            ...
            coord_fps = gather_point(coarse_highres, fps_idx)
            ...
            coarse = gather_point(coord_fps, idx)
