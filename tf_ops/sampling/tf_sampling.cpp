...
class GatherPointGpuOp: public OpKernel{
  public:
    ...
    void Compute(OpKernelContext * context)override{
      ...
      int b=inp_tensor.shape().dim_size(0);
      int n=inp_tensor.shape().dim_size(1);
      int d=inp_tensor.shape().dim_size(2);
...
class GatherPointGradGpuOp: public OpKernel{
  public:
    ...
    void Compute(OpKernelContext * context)override{
      ...
      OP_REQUIRES(context,out_g_tensor.dims()==3 && out_g_tensor.shape().dim_size(0)==b && out_g_tensor.shape().dim_size(1)==m,errors::InvalidArgument("GatherPointGradGpuOp expects (batch_size,num_result,3) out_g shape"));
